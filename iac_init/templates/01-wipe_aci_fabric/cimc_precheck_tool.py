...
logger.add(sink=os.path.join(OUTPUT_BASE_DIR, 'iac_init_log', 'iac-init-main.log'), format="{time} {level} {message}", level="INFO")
...
cimc_precheck("10.124.145.34", "admin", "P@ssw0rd")
